...
import leader from "../../assets/wolfgang.jpg"
    ...
    <>
      <Container variant="spaceBetween" className={classes.container}>
        ...
        <div className={classes.flex}>
          ...
          <p className="zep-typo--normal-body1">{t("overview.content")}</p>
        </div>
      </Container>
      <Container variant="spaceBetween">
        <div className={classes.flex}>
          <p className="zep-typo--normal-body1">{t("overview.strategy")}</p>
        </div>
        <Hidden smDown>
          <div className={classes.imgContainer}>
            <img src={leader} alt="team lead" className={classes.imgReverse} />
          </div>
        </Hidden>
      </Container>
    </>
